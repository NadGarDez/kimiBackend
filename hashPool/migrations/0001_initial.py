    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deployed_contract', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_logs_hashpool', to='contractRegistry.deployedcontract', verbose_name='Contrato Desplegado')),
            ],
            options={
